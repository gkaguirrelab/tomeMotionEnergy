...
# import sys
# sys.path.append('/home/ozzy/Documents/MATLAB/projects/tomeMotionEnergy')
...
class MotionEnergyPyramid(object):
    ...
    def __init__(self,
        ...
        parameter_names, filter_params_array = mk_moten_pyramid_params(
            stimulus_fps,
            ...
            cx=cx,
            cy=cy,
            fixed_spatial_envelope=fixed_spatial_envelope,
            fixed_temporal_envelope=fixed_temporal_envelope
            )
    ...
    def get_filter_spatiotemporal_quadratures(self, filterid=0):
        ...
        sgabor0, sgabor90, tgabor0, tgabor90 = mk_3d_gabor(vhsize,
    ...
    def project_stimulus(self,
        ...
        output = project_stimulus(stimulus,
                                       filters,
    ...
    def raw_project_stimulus(self, stimulus, filters='all', dtype='float32'):
        ...
        output_sin, output_cos = raw_project_stimulus(stimulus,
                                                           filters,
                                                           vhsize=(vdim, hdim),
                                                           dtype=dtype)
